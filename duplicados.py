...
**Casi ningun SKU repetido es un duplicado.** Medido sobre el catalogo del
2026-08-04: de 997 SKU activos, 720 tienen mas de una publicacion activa, pero

  - 565 grupos incluyen una publicacion **de catalogo**, que ML crea aparte,
    con stock compartido y de forma irreversible. Borrarla es tirar la que
    gana el Buy Box.
  - 122 grupos mezclan **Premium (gold_pro) y Clasica (gold_special)**. Eso es
    una decision de precio, no un duplicado: la Premium vale mas porque paga
    ~12 puntos mas de comision.
  - **33 grupos** quedan como duplicados de verdad: mismo tipo de publicacion,
    sin catalogo y sin Full. Son 75 publicaciones y sobran 42.

O sea que el trabajo util son 42 publicaciones, no 1.254. Aplicar el criterio
sobre los 720 grupos seria destruir el catalogo.

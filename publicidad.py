...
def tope_acos(sku, margenes, cfg):
    ...
    Portado de MercadoLibre UY el 18/08/2026, donde se corrigio el 06/08 y no
    se habia traido de vuelta. Aca son **151 de 867 SKU** con margen medido
    los que estaban en el saco equivocado.

...
Como se identifica la familia de un producto, en orden de confianza:
  ...
  2. **Codigo de familia**: los SKU de CRAFTERS traen el codigo embebido
...
# Reglas que definio CRAFTERS. Se cargan una sola vez a la Sheet y despues se
...
def familia_del_sku(sku, codigos):
    """
    Saca el codigo de familia de un SKU de CRAFTERS.
